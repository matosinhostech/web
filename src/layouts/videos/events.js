// Assets
import giddyBanner from 'assets/images/events/placeholder.jpeg'; //giddy-banner-dark.png';
import giddySpeaker from 'assets/images/events/giddy-speaker-red.jpeg';
import ycBanner from 'assets/images/events/placeholder.jpeg'; //yc-banner-dark.jpeg';
import ycSpeaker from 'assets/images/events/yc-speaker-red.jpeg';
import hasuraBanner from 'assets/images/events/placeholder.jpeg'; //hasura-banner-dark.jpg';
import hasuraSpeaker from 'assets/images/events/hasura-speaker-red.jpeg';
import cyberBanner from 'assets/images/events/placeholder.jpeg'; //cyber-banner-dark.jpeg';
import cyberSpeaker from 'assets/images/events/cyber-speaker-red.jpeg';
import neuralBanner from 'assets/images/events/placeholder.jpeg'; //neural-banner-dark.jpg';
...
import diffuseBanner from 'assets/images/events/placeholder.jpeg'; //diffuse-banner-dark.jpg';
...
import mlBanner from 'assets/images/events/placeholder.jpeg';
...
export default [
    ...
    },
    {
        ...
        longDescription: "How to mix crypto with everyday payments? Roberto Sousa, Head of Engineering at Mode, gives us an insight into how to merge crypto into payments and a breakdown of how to design it to scale and all the challenges associated with it.",
    ...
    },
    {
        ...
        longDescription: "Why contribute to open source? Tiago Barbosa, Specialist Solutions Architect at AWS and streamer at the AWS Twitch channel Talk Dev to me, showcases the power and the motivations to do open source projects.",
    ...
    },
    {
        ...
        longDescription: "In the Basecone business, one of the most concerning problems is to accurately translate the information present in an invoice or receipt to a human-readable text in the correct format. During the last year, the data science team has been working on algorithms to solve this.",
    ...
    },
    {
        ...
        projectUrl: "https://taikai-rocket-kit.netlify.app/?path=/story/design-system-atoms-button--button-component",
    ...
    },
    {
        ...
        description: "Learn with André Silva how an Elixir backend and Flutter are useful to create a project analysis tool for small scale software houses.",
        longDescription: "Giddy presents itself as being the very first internal product made by Coletiv Studio, fruit of a whiteboard improvement process that is now a mobile application.\n\nAndré Silva is the CTO of Coletiv and a Software Engineer, with focus on iOS and Elixir development from Porto, Portugal.",
    ...
    },
    {
        ...
        projectUrl: "https://coletiv.com/showcase/giddy/",
        description: "Through Pedro Pregueiro experience, learn how to navigate your way to the most desired startup accelerator in the world – Y Combinator.",
    ...
    },
    {
        ...
        description: "Learn about Hasura and all its potential to quickly build an API capable of responding to all the necessary requirements without compromising the quality and the capability of our POC.",
    ...
    },
    {
        ...
        description: "In this talk we will present the challenges we faced @ EQS Digital while building our data monitoring system to handle large-scale time series datasets of over 100GB.",
        longDescription: "José and Nelson will explain how they structured their data, stored, and indexed it in their databases to provide fast visualization and processing tools to the user, while also being able to process it using our neural network-based systems for forecasting and automated anomaly detection.\n\nJosé Ferrão is a software engineer at EQS Digital and PhD Student of Computer Engineering at UA, working on web visualisation tools, computer vision and machine learning.\n\nNelson Campos is a software engineer at EQS Digital, obtained his master’s degree of Robotics and Autonomous Systems at ISEP. Interested in electronics and full-stack software development.",
    ...
    },
    {
        ...
        description: "DIFFUSE.TV is a media content distribution platform built by Mosano that relies on IPFS protocol, to store & share media content more efficiently.",
        longDescription: "IPFS (InterPlanetary File System) is a protocol, and P2P network for storing and sharing data in a distributed file-sharing system, that can be leveraged to more efficiently store and share large files. It relies on cryptographic hashes that can easily be stored on a blockchain.\n\nFrancisco Sales is passionate about solving complex problems, and simple ones. Always aspiring for perfection, and thriving to innovate through technology. He's also the CoFounder & Tech Lead at Mosano.",
